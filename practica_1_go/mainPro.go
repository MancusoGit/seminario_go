...
func main() {
	...
	if len(os.Args) > 1 {
		...
		fmt.Println("no se encontro la palabra a cambiar en los argumentos")
		fmt.Println("ejecute el programa de la siguiente manera: go run mainPro.go <palabra>")
		fmt.Println("ejemplo: go run main.go hola")
		fmt.Println()
	}
}
